  ...
  return (
    <div className="flex flex-col items-center mt-10">
      ...
      <div className="flex gap-3.5 items-center mt-2">
        <input
          className="bg-white w-[615px] h-[45px] p-2 rounded-lg border border-[#f2f2f2] outline-0"
          type="text"
          placeholder="Curso de react"
        />
        <div className="flex justify-center items-center rounded-sm h-[51px] w-[45px] bg-[#E1F4FF]  ">
